...
public static class RRTexUtil
{
    public static RRTexDataTman ReadDataTman(ChunkyFileReader reader, ChunkHeader header)
    {
    ...
    public static IEnumerable<TextureMip> ReadDataTdat(ChunkyFileReader reader, ChunkHeader header, RRTexDataTman tman, IImageFormat outputFormat, RRTexType textureType = RRTexType.Generic)
    {
        reader.BaseStream.Position = header.DataPosition;
    ...
    public static TextureMip? ReadDataTdatLastMip(ChunkyFileReader reader, ChunkHeader header, RRTexDataTman tman, IImageFormat outputFormat, RRTexType textureType = RRTexType.Generic)
    {
        reader.BaseStream.Position = header.DataPosition;
        int unk = reader.ReadInt32();
